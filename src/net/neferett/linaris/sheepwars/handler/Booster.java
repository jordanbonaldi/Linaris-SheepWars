...
public enum Booster {
    // @formatter:off
    POISON(ChatColor.DARK_GREEN + "" + ChatColor.BOLD + "Poison " + ChatColor.YELLOW + "(4 secondes)", new PoisonBooster(), new ArrayList<TriggerAction>()), NAUSEA(ChatColor.DARK_PURPLE + "" + ChatColor.BOLD + "Nausée " + ChatColor.YELLOW + "(10 secondes)", new NauseaBooster(), new ArrayList<TriggerAction>()), MORE_SHEEP(ChatColor.AQUA + "" + ChatColor.BOLD + "Plus de moutons " + ChatColor.YELLOW + "(+1 mouton)", new MoreSheepBooster(), new ArrayList<TriggerAction>()), REGENERATION(ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "Régénération " + ChatColor.YELLOW + "(6 secondes)", new RegenerationBooster(), new ArrayList<TriggerAction>()), RESISTANCE(ChatColor.WHITE + "" + ChatColor.BOLD + "Résistance " + ChatColor.YELLOW + "(30 secondes)", new ResistanceBooster(), new ArrayList<TriggerAction>()), ARROW_FIRE(ChatColor.GOLD + "" + ChatColor.BOLD + "Flèches de feu " + ChatColor.YELLOW + "(15 secondes)", new ArrowFireBooster(), Arrays.asList(TriggerAction.ARROW_LAUNCH)), ARROW_BACK(ChatColor.GRAY + "" + ChatColor.BOLD + "Flèches de recul " + ChatColor.YELLOW + "(10 secondes)", new ArrowBackBooster(), Arrays.asList(TriggerAction.ARROW_LAUNCH));
    // @formatter:on
